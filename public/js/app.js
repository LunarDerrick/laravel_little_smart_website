...
/***/ "./resources/js/analysis-chart.js":
/*!****************************************!*\
  !*** ./resources/js/analysis-chart.js ***!
  \****************************************/
/***/ (() => {
...
var showChart1 = function showChart1() {
...
function updateSelection(option) {
  ...
  charts[option].forEach(function (chartFunc, i) {
    ...
    // rename title
    var titleElement = chartContainer.closest('.card').querySelector('.card-body h6');
    if (titleElement) {
...
var hasData = function hasData(data) {
  return data.datasets && data.datasets[0].data.every(function (value) {
    return value !== null;
  });
};
...
__webpack_require__(/*! ./analysis-chart */ "./resources/js/analysis-chart.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
